    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900 dark:text-gray-100">{locationCount}</p>
            </div>
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400">Zugewiesene Standorte</p>
        </div>

        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Content-Pläne</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Input-Pläne</p>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-600 dark:text-gray-400">Redaktionspläne</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Link href="/contentplan" className="block">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 dark:text-gray-400">Verwalten Sie Ihre Content-Pläne</p>
          </div>
        </Link>
        ...
        <Link href="/inputplan" className="block">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 dark:text-gray-400">Verwalten Sie Ihre Input-Pläne</p>
          </div>
        </Link>
        ...
        <Link href="/redakplan" className="block">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 dark:text-gray-400">Verwalten Sie Ihre Redaktionspläne</p>
          </div>
        </Link>
      </div>
      ...
      <div className="mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">Übersicht über alle Pläne und deren Status</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow-md p-6">
            ...
            <p className="text-gray-600 dark:text-gray-400">Zeitliche Übersicht der Veröffentlichungen</p>
        ...
        <div className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <Link href="/admin/users" className="block">
              <div className="bg-red-50 dark:bg-red-900/20 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                <div className="flex items-center mb-4">
                ...
                <p className="text-gray-600 dark:text-gray-400">Benutzer und Berechtigungen verwalten</p>
              </div>
            </Link>
            ...
            <Link href="/admin/locations" className="block">
              <div className="bg-red-50 dark:bg-red-900/20 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 dark:text-gray-400">Standorte und Zuordnungen verwalten</p>
              </div>
            </Link>
            ...
            <Link href="/admin/settings" className="block">
              <div className="bg-red-50 dark:bg-red-900/20 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                ...
                <p className="text-gray-600 dark:text-gray-400">Systemeinstellungen verwalten</p>
              </div>
            </Link>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="space-y-2">
              {userWithDetails?.userLocations.map((ul: any) => (
                <div key={ul.id} className="bg-white dark:bg-gray-800 rounded p-3">
                  <p className="font-medium">{ul.location.name}</p>
                  <div className="flex flex-wrap gap-1 mt-1">
                    {ul.roles.map((r: any) => (
                      <span key={r.id} className="text-xs px-2 py-1 bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300 rounded">
                        {r.role.name}
                      </span>
                    ))}
                  </div>
            ...
            <div className="bg-white dark:bg-gray-800 rounded p-3">
              {isAdmin ? (
                ...
                <div className="space-y-4">
                  {userWithDetails?.userLocations.map((ul: any) => (
                    <div key={ul.id} className="border-b dark:border-gray-700 pb-2 mb-2 last:border-b-0 last:pb-0 last:mb-0">
                      ...
                      <div className="flex flex-wrap gap-2 mt-1">
                        {ul.permissions.length > 0 ? (
                          ul.permissions.map((p: any) => (
                            <span key={p.id} className="inline-flex items-center px-2 py-1 text-xs bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-300 rounded">
                          ...
                          <span className="text-xs text-gray-400 dark:text-gray-400">Keine Berechtigungen</span>
                        )}
                      </div>
                    </div>
                  ))}
